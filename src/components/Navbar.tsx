        ...
        >
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {/* Subtle soft ambient light glow behind button on hover */}
                ...
                {/* Top gentle neon spark aura on hover */}
                ...
                {/* Text with glowing text shadow on hover */}
                <span className={`relative z-10 transition-all duration-200 ${
                  ...
                  isActive ? 'text-cyan-300 drop-shadow-[0_0_8px_rgba(0,210,255,0.5)] font-semibold' : ''
                }`}>
                  {item.label}
                </span>

                {/* Active Underline & Electric Glow */}
                {isActive && !item.isUrgent ? (
                  <span
                    className="absolute bottom-0 left-2.5 right-2.5 h-[2px] bg-cyan-400 rounded-full shadow-[0_0_10px_#00D2FF,0_0_20px_#00D2FF]"
                  />
                ) : !item.isUrgent && (
                  /* Hover Underline Light Pulse */
